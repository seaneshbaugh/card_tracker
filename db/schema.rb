...
ActiveRecord::Schema.define(version: 2019_05_22_210901) do
  ...
  create_table "card_part_colorings", force: :cascade do |t|
    t.integer "card_part_id", null: false
    t.string "color_code", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["card_part_id", "color_code"], name: "index_card_part_colorings_on_card_part_id_and_color_code"
    t.index ["color_code", "card_part_id"], name: "index_card_part_colorings_on_color_code_and_card_part_id"
  end

  create_table "card_part_sub_typings", force: :cascade do |t|
    t.integer "card_part_id", null: false
    t.string "card_sub_type_code", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["card_part_id", "card_sub_type_code"], name: "index_c_p_s_t_on_card_part_id_and_card_sub_type_code"
    t.index ["card_sub_type_code", "card_part_id"], name: "index_c_p_s_t_on_card_sub_type_code_and_card_part_id"
  end
  ...
  create_table "card_part_typings", force: :cascade do |t|
    t.integer "card_part_id", null: false
    t.string "card_type_code", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["card_part_id", "card_type_code"], name: "index_card_part_typings_on_card_part_id_and_card_type_code"
    t.index ["card_type_code", "card_part_id"], name: "index_card_part_typings_on_card_type_code_and_card_part_id"
  end
  ...
  create_table "card_sets", force: :cascade do |t|
    ...
    t.index ["parent_id"], name: "index_card_sets_on_parent_id"
